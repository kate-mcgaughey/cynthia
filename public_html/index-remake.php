...
<html lang="en" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html"
	...
	<body class="body">
		...
		<main>
			...
			<div class="col-xs-12">
				<p class="text-center">"Music gives a soul to the universe, wings to the mind, flight to the imagination, and life to everything."    - Plato
				</p>
			</div>
			</section>
			<!-- ========================== -->
			<!--  Section Two               -->
			<!-- ========================== -->
			<section class="parallax" data-stellar-background-ratio="1.5" id="repertoire" style="background-position: 50% -60px;>
				<div class="container-fluid"
					<div class="row">
						<div class="col-md-8">
							<h1>Repertoire</h1>
			...
			<!--  Section Three             -->
			<!-- ========================== -->
			<section class="parallax" data-stellar-background-ratio="1.5" id="rates and terms" style="background-position: 50% -60px;>
				<div class="container">
					<div class="row">
